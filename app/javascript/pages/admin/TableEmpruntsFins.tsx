...
import { Alert, Box, Paper, Table, TableBody, TableCell, TableContainer, TableHead, TablePagination, TableRow, Toolbar, Tooltip, Grid, Card, CardContent, IconButton } from '@mui/material'
                    ...
                    <Grid container spacing={3} alignItems="center">
                        <Grid item xs={12}>
                            <ModernFilter 
                                ...
                                placeholder="Rechercher un emprunt à terminer..."
                            />
                        </Grid>
                    </Grid>
                </Toolbar>
                                    ...
                                    <EmptyState>
                                        ...
                                        <EmptyStateTitle>
                                            {filterProperties.filterBy && filterProperties.searchValue
                                                ...
                                                : "Aucun emprunt à terminer"}
                                        </EmptyStateTitle>
                                        <EmptyStateDescription>
                                            {filterProperties.filterBy && filterProperties.searchValue
                                                ? "Aucun résultat ne correspond à votre recherche"
                                                : "Aucun emprunt en cours n'est à terminer pour le moment"}
                                        </EmptyStateDescription>
                                    </EmptyState>
                                </Grid>
                            )}
